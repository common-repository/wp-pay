...
$buyer_email		= $_POST['buyer_email'];			//默认买家支付宝账号
...
$meta_key = 'price';
$price1=$wpdb->get_var($wpdb->prepare("SELECT meta_value FROM $wpdb->postmeta WHERE  post_id = '".$body."' AND meta_key = %s", $meta_key));
$total_fee=$price1;
...
$show_url			= 'http://www.pakelab.com/wordpress-ufo-cms-theme/';
